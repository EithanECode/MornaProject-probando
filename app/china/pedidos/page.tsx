...
export default function PedidosChina() {
  ...
  // Índice y gradiente para deslizador animado (similar admin)
  ...
  <div className="p-4 md:p-5 lg:p-6 space-y-6 max-w-7xl mx-auto w-full">
          ...
          {/* Tabs: Lista de pedidos | Cajas | Contenedores con deslizador animado */}
          <div className="w-full mb-2">
            <div className="relative overflow-hidden flex w-full gap-1 rounded-2xl p-1 bg-gradient-to-r from-slate-100/70 via-white/60 to-slate-100/70 dark:from-slate-800/60 dark:via-slate-800/40 dark:to-slate-800/60 backdrop-blur border border-slate-200/60 dark:border-slate-700/60 shadow-sm">
              ...
              >
                <Package className="w-4 h-4" /> {t('chinese.ordersPage.tabs.ordersList')}
              </button>
              <button
              ...
              >
                <Boxes className="w-4 h-4" /> {t('chinese.ordersPage.tabs.boxes')}
              </button>
              <button
              ...
              >
                <Boxes className="w-4 h-4" /> {t('chinese.ordersPage.tabs.containers')}
              </button>
            </div>
          </div>

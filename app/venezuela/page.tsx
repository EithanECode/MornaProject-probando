...
export default function VenezuelaDashboard() {
  ...
  return (
    <div className={`min-h-screen flex overflow-x-hidden ${isDark ? 'bg-slate-900' : 'bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50'}`}>
      <Sidebar 
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-4 lg:gap-6">
                  <Link href="/venezuela/pedidos">
                    <Button variant="outline" className={`h-16 md:h-20 lg:h-24 flex flex-col gap-2 md:gap-3 transition-all duration-300 group w-full ${
                      isDark ? 'border-slate-600 text-white hover:bg-slate-700 hover:border-slate-500' : 'hover:bg-blue-50 hover:border-blue-300'
                    }`}>

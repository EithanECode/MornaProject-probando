    ...
    <div className={`min-h-screen flex overflow-x-hidden ${
      ...
      <main className={`flex-1 transition-all duration-300 ${
        ...
        <div className="p-4 md:p-5 lg:p-6 space-y-6">
          {/* Header de la página */}
          <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-orange-500 rounded-xl p-4 md:p-6 text-white">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
              <div>
                <h1 className="text-xl md:text-2xl font-bold">{t('venezuela.soporte.headerTitle')}</h1>
                <p className="text-blue-100 mt-1 text-sm md:text-base">{t('venezuela.soporte.headerSubtitle')}</p>
              </div>
              <div className="grid grid-cols-3 md:flex md:items-center md:space-x-4 gap-4">
                <div className="text-center">
                  ...
                  <p className="text-xs md:text-sm text-blue-100">{t('venezuela.soporte.stats.active')}</p>
                </div>
                <div className="text-center">
                  <p className="text-xl md:text-2xl font-bold">{stats.waiting}</p>
                  <p className="text-xs md:text-sm text-blue-100">{t('venezuela.soporte.stats.waiting')}</p>
                </div>
                <div className="text-center">
                  <p className="text-xl md:text-2xl font-bold">{stats.totalUnread}</p>
                  <p className="text-xs md:text-sm text-blue-100">{t('venezuela.soporte.stats.unread')}</p>
                </div>
              </div>
            </div>
          </div>

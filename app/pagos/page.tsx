    ...
    <div className="min-h-screen flex overflow-x-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main className={`transition-all duration-300 flex-1 ${sidebarExpanded ? 'lg:ml-72 lg:w-[calc(100%-18rem)]' : 'lg:ml-24 lg:w-[calc(100%-6rem)]'}`}> 
        <Header 
          ...
          subtitle="Supervisión y validación global de pagos"
        />
        <div className="p-4 md:p-5 lg:p-6 space-y-6 md:space-y-6 lg:space-y-8">
          ...
          <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-orange-500 rounded-xl p-4 md:p-6 lg:p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div>
                <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-2">Validación de Pagos</h2>
                <p className="text-blue-100 text-sm md:text-base lg:text-lg">Control centralizado de pagos pendientes y confirmados.</p>
                <p className="text-blue-200 mt-2 text-xs md:text-sm">Confirma, audita y monitorea el flujo de verificación.</p>
              </div>
              <div className="flex items-center gap-6">
                ...
                <div className="text-center hidden md:block">
                  ...
                  <p className="text-blue-100 text-xs md:text-sm">Confirmados</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-6">
            <Card className="bg-blue-50 border-blue-200 hover:shadow-lg transition-all duration-300 group">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xs md:text-sm font-medium text-blue-800 flex items-center gap-1"><Clock className="h-3 w-3" /> Pendientes</CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-blue-700">A la espera de validación</p>
            ...
            <Card className="bg-emerald-50 border-emerald-200 hover:shadow-lg transition-all duration-300 group">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xs md:text-sm font-medium text-emerald-800 flex items-center gap-1"><CheckCircle2 className="h-3 w-3" /> Confirmados</CardTitle>
            ...
            <Card className="bg-amber-50 border-amber-200 hover:shadow-lg transition-all duration-300 group">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xs md:text-sm font-medium text-amber-800 flex items-center gap-1"><TrendingUp className="h-3 w-3" /> Monto Total</CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-amber-700">USD procesados</p>
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-slate-200 hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-lg md:text-xl font-semibold flex items-center gap-2"><DollarSign className="h-5 w-5 text-blue-600" /> Acciones Rápidas</CardTitle>
              <p className="text-xs md:text-sm text-slate-600">Flujo operativo del panel de pagos</p>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-4 lg:gap-6">
                <Link href="/pagos/validacion-pagos" className="col-span-2 md:col-span-1">
                  <Button variant="outline" className="h-16 md:h-20 lg:h-24 w-full flex flex-col gap-2 hover:bg-blue-50 hover:border-blue-300 transition-all duration-300 group">
                    ...
                    <span className="text-xs md:text-sm font-medium">Validar Pagos</span>
                  </Button>
                </Link>
              </div>
            </CardContent>

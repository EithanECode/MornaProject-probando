...
interface PitaLogoProps {
  size?: 'sm' | 'md' | 'lg' | 'xl';
  animated?: boolean;
  className?: string;
}

export default function PitaLogo({ size = 'md', animated = true, className = '' }: PitaLogoProps) {
  ...
  return (
    ...
    >
      <svg 
        viewBox="0 0 1887 1356" 
        className={`
          w-full h-full transition-all duration-300
          ${animated && isHovered ? 'scale-110' : 'scale-100'}
          ${animated && isHovered ? 'rotate-1' : 'rotate-0'}
        `}
        style={{
          filter: animated && isHovered 
            ? 'drop-shadow(0 4px 8px rgba(0,0,0,0.4)) drop-shadow(0 2px 4px rgba(0,0,0,0.3))' 
        ...
        <g transform="translate(0.000000,1356.000000) scale(0.100000,-0.100000)" stroke="none">
          ...
          <path 
            ...
            className={`
              ...
              ${animated && isHovered ? 'fill-[#1e3a8a]/80' : 'fill-[#1e3a8a]'}
            `}
          />
